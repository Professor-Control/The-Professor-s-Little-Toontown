...
SecretFriendsInfoPanelText = ['\nThe Open Chat with True Friends Feature\n\nThe Open Chat with True Friends feature enables a member to chat directly with another member within the Professor\'s Little Toontown (the "Service") once the members establish a True Friends connection. Here is a detailed description of the process of creating an Open Chat with True Friends connection between members whom we will call "John" and "Little Cat."\n1. First, John requests a True Friend Code (described below) from within the Service.\n',
...
SuitFaceoffTaunts = {'b': ['Would you like to make a donation?',
       ...
       'You\'ll "B" the opposite of "A" happy Toon when I\'m through with you.'],
 ...
 'mh': ['Are you ready for my take?',
        ...
        "I hope you didn't forget your lines."],
 ...
 'ls': ["It's time to collect on your loan.",
        ...
        'I have a high interest in Toon disposal.'],
 ...
 'f': ["I'm going to tell the boss about you!",
       "I may be just a Flunky, but I'm really spunky.",
 ...
 'gh': ['Put it there, Toon.',
        ...
        "I'm a very hands-\x04on kind of guy.",
        'Would you like some hand-\x04me-\x04downs?',
 ...
 'pp': ['This is only going to sting a little.',
 ...
 'dt': ["I'm going to give you double the trouble.",
        'See if you can stop my double cross.',
        'I serve a mean double-\x04DECKER.',
        "It's time to do some double-\x04dealing.",
 ...
 'tl' :["Prepare for a Nuclear meltdown.",
        ...
        "Toons and toxic waste have one thing in common: they're both disposable.",
        'The only poison needed to take you down is from me.'],
 'hho': ['The boss will be impressed when I defeat you.',
         ...
         "Prepare to be attacked head-\x04on!",
         "Let's make this quick; I am late for the board meeting.",
 ...
 'dpr': ['I can relate, Toon.'],
 'dam': ["The Chairman won't be happy until you are.",
         "You know what they say: All's fair in business and war.",
         "I assure you that you'll find no greater offer."],
 'wsi': ["Stand and face your enemy, for I'm a Cog that's got nothing left to lose.",
         'This is going to be your final stand.',
         'Show me this "power" that you claim to have.',
         'Bear witness to Atticus Wing, the Witness Stand-\x04in!',
         "I'm just going to wing this battle."],
 'hoo': ["I'm way ahead of you.",
         "You're headed for big trouble.",
         "You'll wish this was all in your head.",
         "I'll have your head for this.",
         'Heads up!',
         ...
         "Prepare to be attacked head-\x04on!"],
 'sq': ["I'm here to slay!",
        "You're subject to my cash wrath!",
        'This will be a royal victory for me.',
        "I'm going to royal flush your Laff.",
        "You've messed up royally trying to fight me."],
 'cj': ['Boo!'],
 'ptr': ['No Cog can compare to me.',
         'I mean more business than any of these other Cogs.'],
 'acr': ["I'll make sure you buy the farm."],
 'ff': ["I'm the Foreman."],
 'msv': ["I'm the Supervisor."],
 'oo': ["I'm the Overseer."],
 'cp': ["I'm the Club President."],
 'cnt': ['This battle is going to be a blast!']}
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 1300: 'I think you should choose Toon-\x04up.',
 ...
 5104: "Let's go to the Sellbot Towers.",
 ...
 5110: "Let's go to the Cashbot Vault.",
 5111: "Let's go to the Lawbot Courthouse.",
 ...
 5204: "We're going to the Sellbot Towers.",
 ...
 5210: "We're going to the Cashbot Vault.",
 5211: "We're going to the Lawbot Courthouse.",
 ...
 20000: "It's my day off.",
 20001: "I believe you're in the wrong office.",
 20002: 'Have your people call my people.',
 20003: "You're in no position to meet with me.",
 20004: 'Talk to my assistant.',
 20005: "I'll pretend I don't see you, Toon.",
 20006: "Looks like you've hit rock bottom.",
 20007: "I'm ready to feast.",
 20008: "I'm a sucker for Toons.",
 20009: 'Oh goody, lunch time.',
 20010: 'Perfect timing, I need a quick bite.',
 20011: "I'd like some feedback on my performance.",
 20012: "Let's talk about the bottom line.",
 20013: "You'll find my talents are bottomless.",
 20014: 'Good, I need a little pick-\x04me-\x04up.',
 20015: "I'd love to have you for lunch.",
 20016: 'Looks like your number is up.',
 20017: 'I hope you prefer extra crunchy.',
 20018: "Now you're really in a crunch.",
 20019: 'Is it time for crunch already?',
 20020: "Let's do crunch.",
 20021: 'Where would you like to have your crunch today?',
 20022: "You've given me something to crunch on.",
 20023: 'This will not be smooth.',
 20024: 'Go ahead, try and take a number.',
 20025: 'I could do with a nice crunch about now.',
 20026: "I'm positive you're not going to like this.",
 20027: "I don't know the meaning of no.",
 20028: 'Want to meet?  I say yes, anytime.',
 20029: 'You need some positive enforcement.',
 20030: "I'm going to make a positive impression.",
 20031: "I haven't been wrong yet.",
 20032: "Yes, I'm ready for you.",
 20033: 'Are you positive you want to do this?',
 20034: "I'll be sure to end this on a positive note.",
 20035: "I'm confirming our meeting time.",
 20036: "I won't take no for an answer.",
 20037: SuitFaceoffTaunts['ms'][0],
 20038: SuitFaceoffTaunts['ms'][1],
 20039: SuitFaceoffTaunts['ms'][2],
 20040: SuitFaceoffTaunts['ms'][3],
 20041: SuitFaceoffTaunts['ms'][4],
 20042: SuitFaceoffTaunts['ms'][5],
 20043: SuitFaceoffTaunts['ms'][6],
 20044: SuitFaceoffTaunts['ms'][7],
 20045: SuitFaceoffTaunts['ms'][8],
 20046: SuitFaceoffTaunts['ms'][9],
 20047: SuitFaceoffTaunts['ms'][10],
 20048: SuitFaceoffTaunts['bc'][0],
 20049: SuitFaceoffTaunts['bc'][1],
 20050: SuitFaceoffTaunts['bc'][2],
 20051: SuitFaceoffTaunts['bc'][3],
 20052: SuitFaceoffTaunts['bc'][4],
 20053: SuitFaceoffTaunts['bc'][5],
 20054: SuitFaceoffTaunts['bc'][6],
 20055: SuitFaceoffTaunts['bc'][7],
 20056: SuitFaceoffTaunts['bc'][8],
 20057: SuitFaceoffTaunts['bc'][9],
 20058: SuitFaceoffTaunts['bc'][10],
 20059: SuitFaceoffTaunts['cc'][0],
 20060: SuitFaceoffTaunts['cc'][1],
 20061: SuitFaceoffTaunts['cc'][2],
 20062: SuitFaceoffTaunts['cc'][3],
 20063: SuitFaceoffTaunts['cc'][4],
 20064: SuitFaceoffTaunts['cc'][5],
 20065: SuitFaceoffTaunts['cc'][6],
 20066: SuitFaceoffTaunts['cc'][7],
 20067: SuitFaceoffTaunts['cc'][8],
 20068: SuitFaceoffTaunts['cc'][9],
 20069: SuitFaceoffTaunts['cc'][10],
 20070: SuitFaceoffTaunts['cc'][11],
 20071: SuitFaceoffTaunts['cc'][12],
 20072: SuitFaceoffTaunts['cc'][13],
 20073: SuitFaceoffTaunts['nd'][0],
 20074: SuitFaceoffTaunts['nd'][1],
 20075: SuitFaceoffTaunts['nd'][2],
 20076: SuitFaceoffTaunts['nd'][3],
 20077: SuitFaceoffTaunts['nd'][4],
 20078: SuitFaceoffTaunts['nd'][5],
 20079: SuitFaceoffTaunts['nd'][6],
 20080: SuitFaceoffTaunts['nd'][7],
 20081: SuitFaceoffTaunts['nd'][8],
 20082: SuitFaceoffTaunts['nd'][9],
 20083: SuitFaceoffTaunts['ac'][0],
 20084: SuitFaceoffTaunts['ac'][1],
 20085: SuitFaceoffTaunts['ac'][2],
 20086: SuitFaceoffTaunts['ac'][3],
 20087: SuitFaceoffTaunts['ac'][4],
 20088: SuitFaceoffTaunts['ac'][5],
 20089: SuitFaceoffTaunts['ac'][6],
 20090: SuitFaceoffTaunts['ac'][7],
 20091: SuitFaceoffTaunts['ac'][8],
 20092: SuitFaceoffTaunts['ac'][9],
 20093: SuitFaceoffTaunts['ac'][10],
 20094: SuitFaceoffTaunts['ac'][11],
 20095: SuitFaceoffTaunts['tf'][0],
 20096: SuitFaceoffTaunts['tf'][1],
 20097: SuitFaceoffTaunts['tf'][2],
 20098: SuitFaceoffTaunts['tf'][3],
 20099: SuitFaceoffTaunts['tf'][4],
 20100: SuitFaceoffTaunts['tf'][5],
 20101: SuitFaceoffTaunts['tf'][6],
 20102: SuitFaceoffTaunts['tf'][7],
 20103: SuitFaceoffTaunts['tf'][8],
 20104: SuitFaceoffTaunts['tf'][9],
 20105: SuitFaceoffTaunts['tf'][10],
 20106: SuitFaceoffTaunts['hh'][0],
 20107: SuitFaceoffTaunts['hh'][1],
 20108: SuitFaceoffTaunts['hh'][2],
 20109: SuitFaceoffTaunts['hh'][3],
 20110: SuitFaceoffTaunts['hh'][4],
 20111: SuitFaceoffTaunts['hh'][5],
 20112: SuitFaceoffTaunts['hh'][6],
 20113: SuitFaceoffTaunts['hh'][7],
 20114: SuitFaceoffTaunts['hh'][8],
 20115: SuitFaceoffTaunts['hh'][9],
 20116: SuitFaceoffTaunts['hh'][10],
 20117: SuitFaceoffTaunts['le'][0],
 20118: SuitFaceoffTaunts['le'][1],
 20119: SuitFaceoffTaunts['le'][2],
 20120: SuitFaceoffTaunts['le'][3],
 20121: SuitFaceoffTaunts['le'][4],
 20122: SuitFaceoffTaunts['le'][5],
 20123: SuitFaceoffTaunts['le'][6],
 20124: SuitFaceoffTaunts['le'][7],
 20125: SuitFaceoffTaunts['le'][8],
 20126: SuitFaceoffTaunts['le'][9],
 20127: SuitFaceoffTaunts['bs'][0],
 20128: SuitFaceoffTaunts['bs'][1],
 20129: SuitFaceoffTaunts['bs'][2],
 20130: SuitFaceoffTaunts['bs'][3],
 20131: SuitFaceoffTaunts['bs'][4],
 20132: SuitFaceoffTaunts['bs'][5],
 20133: SuitFaceoffTaunts['bs'][6],
 20134: SuitFaceoffTaunts['bs'][7],
 20135: SuitFaceoffTaunts['bs'][8],
 20136: SuitFaceoffTaunts['bs'][9],
 20137: SuitFaceoffTaunts['bs'][10],
 20138: SuitFaceoffTaunts['cr'][0],
 20139: SuitFaceoffTaunts['cr'][1],
 20140: SuitFaceoffTaunts['cr'][2],
 20141: SuitFaceoffTaunts['cr'][3],
 20142: SuitFaceoffTaunts['cr'][4],
 20143: SuitFaceoffTaunts['cr'][5],
 20144: SuitFaceoffTaunts['cr'][6],
 20145: SuitFaceoffTaunts['cr'][7],
 20146: SuitFaceoffTaunts['cr'][8],
 20147: SuitFaceoffTaunts['cr'][9],
 20148: SuitFaceoffTaunts['cr'][10],
 20149: SuitFaceoffTaunts['tbc'][0],
 20150: SuitFaceoffTaunts['tbc'][1],
 20151: SuitFaceoffTaunts['tbc'][2],
 20152: SuitFaceoffTaunts['tbc'][3],
 20153: SuitFaceoffTaunts['tbc'][4],
 20154: SuitFaceoffTaunts['tbc'][5],
 20155: SuitFaceoffTaunts['tbc'][6],
 20156: SuitFaceoffTaunts['tbc'][7],
 20157: SuitFaceoffTaunts['tbc'][8],
 20158: SuitFaceoffTaunts['tbc'][9],
 20159: SuitFaceoffTaunts['tbc'][10],
 20160: SuitFaceoffTaunts['tbc'][11],
 20161: SuitFaceoffTaunts['ds'][0],
 20162: SuitFaceoffTaunts['ds'][1],
 20163: SuitFaceoffTaunts['ds'][2],
 20164: SuitFaceoffTaunts['ds'][3],
 20165: SuitFaceoffTaunts['ds'][4],
 20166: SuitFaceoffTaunts['ds'][5],
 20167: SuitFaceoffTaunts['ds'][6],
 20168: SuitFaceoffTaunts['ds'][7],
 20169: SuitFaceoffTaunts['gh'][0],
 20170: SuitFaceoffTaunts['gh'][1],
 20171: SuitFaceoffTaunts['gh'][2],
 20172: SuitFaceoffTaunts['gh'][3],
 20173: SuitFaceoffTaunts['gh'][4],
 20174: SuitFaceoffTaunts['gh'][5],
 20175: SuitFaceoffTaunts['gh'][6],
 20176: SuitFaceoffTaunts['gh'][7],
 20177: SuitFaceoffTaunts['gh'][8],
 20178: SuitFaceoffTaunts['gh'][9],
 20179: SuitFaceoffTaunts['gh'][10],
 20180: SuitFaceoffTaunts['gh'][11],
 20181: SuitFaceoffTaunts['gh'][12],
 20182: SuitFaceoffTaunts['pp'][0],
 20183: SuitFaceoffTaunts['pp'][1],
 20184: SuitFaceoffTaunts['pp'][2],
 20185: SuitFaceoffTaunts['pp'][3],
 20186: SuitFaceoffTaunts['pp'][4],
 20187: SuitFaceoffTaunts['pp'][5],
 20188: SuitFaceoffTaunts['pp'][6],
 20189: SuitFaceoffTaunts['pp'][7],
 20190: SuitFaceoffTaunts['pp'][8],
 20191: SuitFaceoffTaunts['pp'][9],
 20192: SuitFaceoffTaunts['b'][0],
 20193: SuitFaceoffTaunts['b'][1],
 20194: SuitFaceoffTaunts['b'][2],
 20195: SuitFaceoffTaunts['b'][3],
 20196: SuitFaceoffTaunts['b'][4],
 20197: SuitFaceoffTaunts['b'][5],
 20198: SuitFaceoffTaunts['b'][6],
 20199: SuitFaceoffTaunts['b'][7],
 20200: SuitFaceoffTaunts['b'][8],
 20201: SuitFaceoffTaunts['b'][9],
 20202: SuitFaceoffTaunts['b'][10],
 20203: SuitFaceoffTaunts['b'][11],
 20204: SuitFaceoffTaunts['b'][12],
 20205: SuitFaceoffTaunts['f'][0],
 20206: SuitFaceoffTaunts['f'][1],
 20207: SuitFaceoffTaunts['f'][2],
 20208: SuitFaceoffTaunts['f'][3],
 20209: SuitFaceoffTaunts['f'][4],
 20210: SuitFaceoffTaunts['f'][5],
 20211: SuitFaceoffTaunts['f'][6],
 20212: SuitFaceoffTaunts['f'][7],
 20213: SuitFaceoffTaunts['f'][8],
 20214: SuitFaceoffTaunts['f'][9],
 20215: SuitFaceoffTaunts['f'][10],
 20216: SuitFaceoffTaunts['mm'][0],
 20217: SuitFaceoffTaunts['mm'][1],
 20218: SuitFaceoffTaunts['mm'][2],
 20219: SuitFaceoffTaunts['mm'][3],
 20220: SuitFaceoffTaunts['mm'][4],
 20221: SuitFaceoffTaunts['mm'][5],
 20222: SuitFaceoffTaunts['mm'][6],
 20223: SuitFaceoffTaunts['mm'][7],
 20224: SuitFaceoffTaunts['mm'][8],
 20225: SuitFaceoffTaunts['mm'][9],
 20226: SuitFaceoffTaunts['mm'][10],
 20227: SuitFaceoffTaunts['mm'][11],
 20228: SuitFaceoffTaunts['mm'][12],
 20229: SuitFaceoffTaunts['mm'][13],
 20230: SuitFaceoffTaunts['tw'][0],
 20231: SuitFaceoffTaunts['tw'][1],
 20232: SuitFaceoffTaunts['tw'][2],
 20233: SuitFaceoffTaunts['tw'][3],
 20234: SuitFaceoffTaunts['tw'][4],
 20235: SuitFaceoffTaunts['tw'][5],
 20236: SuitFaceoffTaunts['tw'][6],
 20237: SuitFaceoffTaunts['tw'][7],
 20238: SuitFaceoffTaunts['tw'][8],
 20239: SuitFaceoffTaunts['tw'][9],
 20240: SuitFaceoffTaunts['tw'][10],
 20241: SuitFaceoffTaunts['mb'][0],
 20242: SuitFaceoffTaunts['mb'][1],
 20243: SuitFaceoffTaunts['mb'][2],
 20244: SuitFaceoffTaunts['mb'][3],
 20245: SuitFaceoffTaunts['mb'][4],
 20246: SuitFaceoffTaunts['mb'][5],
 20247: SuitFaceoffTaunts['mb'][6],
 20248: SuitFaceoffTaunts['mb'][7],
 20249: SuitFaceoffTaunts['mb'][8],
 20250: SuitFaceoffTaunts['mb'][9],
 20251: SuitFaceoffTaunts['m'][0],
 20252: SuitFaceoffTaunts['m'][1],
 20253: SuitFaceoffTaunts['m'][2],
 20254: SuitFaceoffTaunts['m'][3],
 20255: SuitFaceoffTaunts['m'][4],
 20256: SuitFaceoffTaunts['m'][5],
 20257: SuitFaceoffTaunts['m'][6],
 20258: SuitFaceoffTaunts['m'][7],
 20259: SuitFaceoffTaunts['m'][8],
 20260: SuitFaceoffTaunts['mh'][0],
 20261: SuitFaceoffTaunts['mh'][1],
 20262: SuitFaceoffTaunts['mh'][2],
 20263: SuitFaceoffTaunts['mh'][3],
 20264: SuitFaceoffTaunts['mh'][4],
 20265: SuitFaceoffTaunts['mh'][5],
 20266: SuitFaceoffTaunts['mh'][6],
 20267: SuitFaceoffTaunts['mh'][7],
 20268: SuitFaceoffTaunts['mh'][8],
 20269: SuitFaceoffTaunts['mh'][9],
 20270: SuitFaceoffTaunts['mh'][10],
 20271: SuitFaceoffTaunts['mh'][11],
 20272: SuitFaceoffTaunts['dt'][0],
 20273: SuitFaceoffTaunts['dt'][1],
 20274: SuitFaceoffTaunts['dt'][2],
 20275: SuitFaceoffTaunts['dt'][3],
 20276: SuitFaceoffTaunts['dt'][4],
 20277: SuitFaceoffTaunts['dt'][5],
 20278: SuitFaceoffTaunts['dt'][6],
 20279: SuitFaceoffTaunts['dt'][7],
 20280: SuitFaceoffTaunts['dt'][8],
 20281: SuitFaceoffTaunts['dt'][9],
 20282: SuitFaceoffTaunts['p'][0],
 20283: SuitFaceoffTaunts['p'][1],
 20284: SuitFaceoffTaunts['p'][2],
 20285: SuitFaceoffTaunts['p'][3],
 20286: SuitFaceoffTaunts['p'][4],
 20287: SuitFaceoffTaunts['p'][5],
 20288: SuitFaceoffTaunts['p'][6],
 20289: SuitFaceoffTaunts['p'][7],
 20290: SuitFaceoffTaunts['p'][8],
 20291: SuitFaceoffTaunts['p'][9],
 20292: SuitFaceoffTaunts['p'][10],
 20293: SuitFaceoffTaunts['tm'][0],
 20294: SuitFaceoffTaunts['tm'][1],
 20295: SuitFaceoffTaunts['tm'][2],
 20296: SuitFaceoffTaunts['tm'][3],
 20297: SuitFaceoffTaunts['tm'][4],
 20298: SuitFaceoffTaunts['tm'][5],
 20299: SuitFaceoffTaunts['tm'][6],
 20300: SuitFaceoffTaunts['tm'][7],
 20301: SuitFaceoffTaunts['tm'][8],
 20302: SuitFaceoffTaunts['tm'][9],
 20303: SuitFaceoffTaunts['tm'][10],
 20304: SuitFaceoffTaunts['bw'][0],
 20305: SuitFaceoffTaunts['bw'][1],
 20306: SuitFaceoffTaunts['bw'][2],
 20307: SuitFaceoffTaunts['bw'][3],
 20308: SuitFaceoffTaunts['bw'][4],
 20309: SuitFaceoffTaunts['bw'][5],
 20310: SuitFaceoffTaunts['bw'][6],
 20311: SuitFaceoffTaunts['bw'][7],
 20312: SuitFaceoffTaunts['bw'][8],
 20313: SuitFaceoffTaunts['bw'][9],
 20314: SuitFaceoffTaunts['ls'][0],
 20315: SuitFaceoffTaunts['ls'][1],
 20316: SuitFaceoffTaunts['ls'][2],
 20317: SuitFaceoffTaunts['ls'][3],
 20318: SuitFaceoffTaunts['ls'][4],
 20319: SuitFaceoffTaunts['ls'][5],
 20320: SuitFaceoffTaunts['ls'][6],
 20321: SuitFaceoffTaunts['ls'][7],
 20322: SuitFaceoffTaunts['ls'][8],
 20323: SuitFaceoffTaunts['ls'][9],
 20324: SuitFaceoffTaunts['ls'][10],
 20325: SuitFaceoffTaunts['ls'][11],
 20326: SuitFaceoffTaunts['rb'][0],
 20327: SuitFaceoffTaunts['rb'][1],
 20328: SuitFaceoffTaunts['rb'][2],
 20329: SuitFaceoffTaunts['rb'][3],
 20330: SuitFaceoffTaunts['rb'][4],
 20331: SuitFaceoffTaunts['rb'][5],
 20332: SuitFaceoffTaunts['rb'][6],
 20333: SuitFaceoffTaunts['rb'][7],
 20334: SuitFaceoffTaunts['rb'][8],
 20335: SuitFaceoffTaunts['rb'][9],
 20336: SuitFaceoffTaunts['sc'][0],
 20337: SuitFaceoffTaunts['sc'][1],
 20338: SuitFaceoffTaunts['sc'][2],
 20339: SuitFaceoffTaunts['sc'][3],
 20340: SuitFaceoffTaunts['sc'][4],
 20341: SuitFaceoffTaunts['sc'][5],
 20342: SuitFaceoffTaunts['sc'][6],
 20343: SuitFaceoffTaunts['sc'][7],
 20344: SuitFaceoffTaunts['sc'][8],
 20345: SuitFaceoffTaunts['sc'][9],
 20346: SuitFaceoffTaunts['sc'][10],
 20347: SuitFaceoffTaunts['sd'][0],
 20348: SuitFaceoffTaunts['sd'][1],
 20349: SuitFaceoffTaunts['sd'][2],
 20350: SuitFaceoffTaunts['sd'][3],
 20351: SuitFaceoffTaunts['sd'][4],
 20352: SuitFaceoffTaunts['sd'][5],
 20353: SuitFaceoffTaunts['sd'][6],
 20354: SuitFaceoffTaunts['sd'][7],
 20355: SuitFaceoffTaunts['sd'][8],
 20356: SuitFaceoffTaunts['sd'][9],
 21000: 'Here boy!',
 21001: 'Here girl!',
 21002: 'Stay.',
 21003: 'Good boy!',
 ...
 30152: 'The V.P. had his power drained by Doodles!',
 30153: 'Everyone can fight the V.P. right now!',
 30154: "You don't need a Sellbot Disguise to fight the V.P.!",
 30155: 'You get a Rental Suit when you go into Sellbot Towers.',
 30156: 'Do you like my Rental Suit? Sorry about the safety pins!',
 30157: "It's best to have eight Toons to fight the V.P.",
 30158: 'Will you help me fight the V.P.?',
 30159: 'Do you want to fight the V.P. with me?',
 30160: 'Would you like to join my Sellbot V.P. group?',
 30161: 'I am looking for a Toon with a Rental Suit to fight the V.P.',
 30162: 'I have a Rental Suit, and am looking to fight the V.P.',
 ...
 30170: 'Now we fight the V.P.!',
 30171: 'Aim your pies by pressing the Delete button.',
 30172: "Two Toons should throw pies through the V.P.'s open doors!",
 30173: "I'll stun the V.P. from the front.",
 30174: "I'll stun the V.P. from the back.",
 30175: 'Jump when the V.P. jumps!',
 ...
 30186: 'What am I going to spend all these jellybeans on?',
 30187: "I'm going to adopt a Doodle with all these jellybeans!",
 30188: "I'm going to throw a huge party!",
 30189: "I'm going to decorate my whole Estate!",
 30190: "I'm going to buy a whole new wardrobe!",
 ...
 30414: 'Collect Jokes to get a Toon-\x04Up at the end!',
...
CustomSCStrings = {10: 'Oh, well.',
 ...
 7010: 'That really throws a monkey-\x04wrench in things.',
 ...
 7060: "Who's going to be monkey in the middle?",
...
SCMenuCommonCogIndices = (20000, 20005)
SCMenuCustomCogIndices = {'bf': (20006, 20015),
 'nc': (20016, 20025),
 'ym': (20026, 20036),
 'ms': (20037, 20047),
 'bc': (20048, 20058),
