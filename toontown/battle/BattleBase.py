...
def getDefaultSuitAttacks():
    suitAttacks = [[NO_ID,
     ...
     [NO_ID,
      ...
      0,
      0,
      0]] # TODO: Support for more than four Cogs at a time
    return suitAttacks
...
class BattleBase:
    ...
    suitPoints = (((Point3(0, 5, 0), 180),),
     ((Point3(2, 5.3, 0), 170), (Point3(-2, 5.3, 0), 180)),
     ((Point3(4, 5.2, 0), 170), (Point3(0, 6, 0), 180), (Point3(-4, 5.2, 0), 190)),
     ((Point3(6, 4.4, 0), 160), (Point3(2, 6.3, 0), 170), (Point3(-2, 6.3, 0), 190), (Point3(-6, 4.4, 0), 200)),
     ((Point3(8, 5.5, 0), 160), (Point3(4, 6.2, 0), 170), (Point3(0, 7, 0), 180), (Point3(-4, 6.2, 0), 190), (Point3(-8, 5.5, 0), 200)))
    suitPendingPoints = ((Point3(-8, 8.2, 0), 200),
     (Point3(-4, 8.2, 0), 190),
     (Point3(0, 9, 0), 180),
     (Point3(4, 8.2, 0), 170),
     (Point3(8, 3.2, 0), 160))
