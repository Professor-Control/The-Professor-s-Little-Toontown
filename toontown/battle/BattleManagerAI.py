...
class BattleManagerAI:
    ...
    def newBattle(self, cellId, zoneId, pos, suit, toonId, finishCallback = None, maxSuits = 4, interactivePropTrackBonus = -1): # TODO: Support for more than four Cogs at a time
        if cellId in self.cellId2battle:
