...
class BattleSounds:
    ...
    def setupSearchPath(self):
        ...
        self.sfxSearchPath.appendDirectory(Filename('/phase_8/audio/sfx'))
        self.sfxSearchPath.appendDirectory(Filename('/phase_9/audio/sfx'))
        self.sfxSearchPath.appendDirectory(Filename('/phase_14/audio/sfx'))
