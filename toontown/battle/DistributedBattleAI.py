...
class DistributedBattleAI(DistributedBattleBaseAI.DistributedBattleBaseAI):
    ...
    def __init__(self, air, battleMgr, pos, suit, toonId, zoneId, finishCallback = None, maxSuits = 4, tutorialFlag = 0, levelFlag = 0, interactivePropTrackBonus = -1): # TODO: Support for more than four Cogs at a time
