toonHealJokes = [['What goes TICK-TICK-TICK-WOOF?', 'A watchdog.'],
 ...
 ['Why is it hard for ghosts to lie?', 'You can see right through them.'],
 ...
 ['What do you call a blind dinosaur?', "An I-don't-think-it-saurus."],
 ...
 ["What's the difference between bird flu and swine flu?", 'Bird flu needs tweetments while swine flu needs oinkments.'],
 ...
 ['How do you keep a bull from charging?', 'Keep it from the plugs.'],
 ...
 ['How do trains hear?', 'Through the enginears.'],
 ...
 ["What works only when it's fired?", 'A cannonball.'],
 ["Why wasn't there any food left after the monster party?", 'Because everyone was a goblin!'],
 ["Why wasn't there any food left after the monster party?", 'Everyone kept goblin down on the food.'],
 ...
 ['Where do birds go to file cases?', 'To the legal eagles.'],
 ...
 ['What do you call someone that is afraid of St. Nicholas?', 'Claustrophobic.'],
 ...
 ['What needs a bath and keeps crossing the street?', 'A dirty-\x04double crosser.'],
 ...
 ["What's gray, weighs 200 pounds and says, 'Here Kitty, kitty?'", 'A two hundred-pound mouse.'],
 ...
 ['What did the stocking say to the shoe?', '"See you later; I got to run."'],
 ...
 ['What did the doctor say to the sick banana?', '"Are you peeling well?"'],
 ...
 ["What's a princely cardinal that's always a distraction?", 'A red-heir-wing.'],
 ['Why are legal eagles so great in law?', "They're always at the top of the pecking order."],
 ['What illness can you get from bees?', 'Hives.'],
 ['What do you get when you cross a shoe with bread?', 'A loafer.'],
 ["How do you communicate with someone when you're feeling guilty?", 'Remorse code.'],
 ["Why couldn't the robber break into the digital vault?", 'The code was too complicated.'],
 ["What's a bee overseer called?", 'A hivemind.']]
