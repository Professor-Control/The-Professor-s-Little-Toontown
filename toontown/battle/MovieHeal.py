...
def __healToon(toon, hp, ineffective, hasInteractivePropHealBonus):
    ...
    if ineffective == 1:
        laughter = random.choice(('Hmm...', 'Heh...', 'Ha...', 'Harr harr...'))
    else:
        maxDam = AvPropDamage[0][1][0][1]
        if hp >= maxDam - 1:
            laughter = random.choice(('BWAH HAH HAH!', 'HO HO HO!', 'HA HA HA!', 'HEE HEE HEE!'))
        else:
            laughter = random.choice(('Ha ha ha!', 'Hee hee!', 'Tee hee!', 'Ha ha!'))
