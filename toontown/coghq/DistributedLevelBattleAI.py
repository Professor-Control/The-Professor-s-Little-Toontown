...
class DistributedLevelBattleAI(DistributedBattleAI.DistributedBattleAI):
    ...
    def __init__(self, air, battleMgr, pos, suit, toonId, zoneId, level, battleCellId, winState, roundCallback = None, finishCallback = None, maxSuits = 4): # TODO: Support for more than four Cogs at a time
        self.blocker = None
        self.level = level
