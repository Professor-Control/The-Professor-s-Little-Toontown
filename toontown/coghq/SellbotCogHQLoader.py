...
class SellbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def loadPlaceGeom(self, zoneId):
        ...
        if zoneId == ToontownGlobals.SellbotHQ:
            ...
            factoryTypeText = DirectGui.OnscreenText(text='Sellbot', font=ToontownGlobals.getSuitFont(), pos=(0, -0.25), scale=0.075, mayChange=False, parent=factorySign)
            ...
            hqTypeText = DirectGui.OnscreenText(text='Sellbot', font=ToontownGlobals.getSuitFont(), pos=(0, -0.25), scale=0.075, mayChange=False, parent=hqSign)
