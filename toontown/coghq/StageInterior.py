...
class StageInterior(BattlePlace.BattlePlace):
    ...
    def load(self):
        ...
        musicName = random.choice(['phase_14/audio/bgm/LB_office_a.ogg', 'phase_14/audio/bgm/LB_office_b.ogg', 'phase_14/audio/bgm/LB_office_c.ogg'])
        self.music = base.loader.loadMusic(musicName)
        battleMusicName = random.choice(['phase_14/audio/bgm/LB_office_encntr_a.ogg', 'phase_14/audio/bgm/LB_office_encntr_b.ogg', 'phase_14/audio/bgm/LB_office_encntr_c.ogg'])
        self.loader.battleMusic = base.loadMusic(battleMusicName)

    def unload(self):
        self.parentFSM.getStateNamed('stageInterior').removeChild(self.fsm)
        del self.music
        del self.loader.battleMusic
        del self.fsm
        del self.parentFSM
