...
ItemDict = {1: ['Pair of Glasses', 'Pairs of Glasses', 'a '],
 2: ['Key', 'Keys', 'a '],
 ...
 21: ['PB&J Sandwich', 'PB&J Sandwiches', 'a '],
 22: ['Circuit', 'Circuits', 'a '],
 23: ['Rubber Chicken Sandwich', 'Rubber Chicken Sandwiches', 'a '],
 110: ['TIP Clothing Ticket', 'TIP Clothing Tickets', 'a '],
 ...
 4008: ['Cloudy Castanet', 'Cloudy Castanets', 'a '],
 ...
 5013: ['Sellbot HQ Blueprints', 'Sellbot HQ Blueprints', 'some '],
 5014: ['Sellbot HQ Memo', 'Sellbot HQ Memos', 'a '],
 5015: ['Sellbot HQ Memo', 'Sellbot HQ Memos', 'a '],
 5016: ['Sellbot HQ Memo', 'Sellbot HQ Memos', 'a '],
 5017: ['Sellbot HQ Memo', 'Sellbot HQ Memos', 'a '],
 ...
 3014: ['Talking toad', 'Talking toads', 'a '],
 ...
 6013: ['Vacation Clothing', 'Vacation Clothing', 'some '],
 ...
 7015: ['Roll of Film', 'Rolls of Film', 'a '],
 8001: ["Surlee's Pocketwatch", "Surlee's Pocketwatches", '']}
CompleteString = 'Complete'
NotChosenString = 'Not chosen'
DefaultGreeting = ('Hello, _avName_!',
 'Hi, _avName_!',
 'Hey there, _avName_!',
 'Say there, _avName_!',
 'Welcome, _avName_!',
 ...
 'Greetings _avName_!')
DefaultIncomplete = ("How's that task coming, _avName_?",
...
DefaultIncompleteProgress = ('You came to the right place, but you need to finish your ToonTask first.', 'When you are finished with that ToonTask, come back here.', 'Come back when you are finished with your ToonTask.')
DefaultIncompleteWrongNPC = ('Nice work on that ToonTask. You should go visit _toNpcName_._where_', 'Looks like you are ready to finish your ToonTask. Go see _toNpcName_._where_.', 'Go see _toNpcName_ to finish your ToonTask._where_')
DefaultComplete = ('Nice work! Here is your reward...', 'Great job, _avName_! Take this reward...', 'Wonderful job, _avName_! Here is your reward...')
DefaultLeaving = ('Bye!', 'Goodbye!', 'So long, _avName_.', 'See ya, _avName_!', 'Good luck!', 'Have fun in Toontown!', 'See you later!')
DefaultReject = ('Hello.',
 'Can I help you?',
 'How are you?',
 'Hello there.',
...
class LocationBasedQuest(Quest):
    ...
    def getLocationName(self):
        ...
        if loc == Anywhere:
            ...
            locName = ' %(inPhrase)s %(location)s' % {'inPhrase': ToontownGlobals.hoodNameMap[loc][1],
            ...
            locName = ' %(inPhrase)s %(location)s' % {'inPhrase': ToontownGlobals.StreetNames[loc][1],
...
class CogQuest(LocationBasedQuest):
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        numCogs = self.getNumCogs()
        if numCogs == 1:
            text = 'I need to defeat %(cogName)s%(cogLoc)s.'
        else:
            text = 'I need to defeat some %(cogName)s%(cogLoc)s.'
...
class CogTrackQuest(CogQuest):
    trackCodes = ['c',
     ...
     's',
     'd']
    trackNamesS = ['a Bossbot',
     'a Lawbot',
     'a Cashbot',
     'a Sellbot',
     'a Darkbot']
    trackNamesP = ['Bossbots',
     'Lawbots',
     'Cashbots',
     'Sellbots',
     'Darkbots']
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            return '%(progress)s of %(numCogs)s defeated' % {'progress': questDesc[4],
             'numCogs': self.getNumCogs()}
...
class SkelecogTrackQuest(CogTrackQuest, SkelecogQBase):
    trackNamesS = ['a Bossbot Skelecog',
     'a Lawbot Skelecog',
     'a Cashbot Skelecog',
     'a Sellbot Skelecog']
    trackNamesP = ['Bossbot Skelecogs',
     'Lawbot Skelecogs',
     'Cashbot Skelecogs',
     'Sellbot Skelecogs']
...
class SkeleReviveQBase:
    def getCogNameString(self):
        numCogs = self.getNumCogs()
        if numCogs == 1:
            return 'a Version 2.0 Cog'
        else:
            return 'Version 2.0 Cogs'
...
class BuildingQuest(CogQuest):
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            return '%(progress)s of %(num)s defeated' % {'progress': questDesc[4],
             'num': self.getNumBuildings()}

    def getObjectiveStrings(self):
        count = self.getNumBuildings()
        floors = ('', 'two+', 'three+', 'four+', 'five+')[self.getNumFloors() - 1]
...
'''taskId: (tierNumber,
       Start or Cont to indicate if this task starts a chain or not,
       (questClass initialization and arguments),
       fromNPC,
       toNPC,
       rewardId,
       nextQuestId if part of a chain (can be a list or tuple and it'll pick a random one to create a branching path),
       dialog (see other quests for how dialog is))'''
QuestDict = {
  101: (TT_TIER, # ToonTask tier
       Start,
       (CogQuest, # type of quest
        Anywhere,
        1,
        'cc'), # Objective
       Any,
 ...
 160: (TT_TIER,
       ...
       175,
       {GREETING: '',
        QUEST: "Okay, now I think you are ready for something more rewarding.\x07If you can defeat 3 Bossbots I'll give you a little bonus.",
        ...
        COMPLETE: ('Nice work! Here is your reward...', 'Great job, _avName_! Take this reward...', 'Wonderful job, _avName_! Here is your reward...'),
        LEAVING: ('Bye!', 'Goodbye!', 'So long, _avName_.', 'See ya, _avName_!', 'Good luck!', 'Have fun in Toontown!', 'See you later!')}),
 161: (TT_TIER,
       OBSOLETE,
       (CogTrackQuest,
 ...
 165: (TT_TIER + 1,
       ...
       NA,
       (166),
       {GREETING: ('Hello, _avName_!', 'Hi, _avName_!', 'Hey there, _avName_!', 'Say there, _avName_!', 'Welcome, _avName_!', 'Howdy, _avName_!', 'How are you, _avName_?', 'Greetings _avName_!'),
        QUEST: 'Looks like you need to practice training your gags.\x07Every time you hit a Cog with one of your gags, your experience increases.\x07When you get enough experience, you will be able to use an even better gag.\x07Go practice your gags by defeating 4 Cogs.'}),
 166: (TT_TIER + 1,
       Cont,
       (CogTrackQuest,
        Anywhere,
 ...
 167: (TT_TIER + 1,
       ...
       NA,
       (168),
       {QUEST: 'Splendid!\x07Now, go defeat a Lawbot.'}),
 168: (TT_TIER + 1,
       Cont,
       (CogTrackQuest,
        Anywhere,
       ...
       NA,
       (169),
       {QUEST: 'Amazing!\x07Now, go defeat a Cashbot.'}),
 169: (TT_TIER + 1,
       Cont,
       (CogTrackQuest,
        Anywhere,
       ...
       NA,
       (170, 171, 172, 173),
       {QUEST: 'Excellent!\x07Now, go defeat a Sellbot.'}),
 170: (TT_TIER + 1,
       Cont,
       (VisitQuest,),
       Same,
 ...
 1058: (TT_TIER + 2,
        ...
        200,
        NA,
        {QUEST: "Good job - I knew you could do it.\x07Here's the pump.  I'm sure _toNpcName_ will be glad to get it back...\x07...but tell him that he still owes me the monkeywrench!",
         LEAVING: '',
         GREETING: '',
         COMPLETE: "Yeehaw!  Now I'm good to go!\x07A monkeywrench?  That can wait.\x07Take this as a reward."}),
 1059: (TT_TIER + 2,
        Start,
        (VisitQuest,),
        Any,
 ...
 1061: (TT_TIER + 2,
        ...
        101,
        NA,
        {QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Pencil Pushers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Pencil Pushers in Toontown Central for your reward.",
         LEAVING: '',
 ...
 1062: (TT_TIER + 2,
        ...
        101,
        NA,
        {QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Bloodsuckers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Bloodsuckers in Toontown Central for your reward.",
         LEAVING: '',
         COMPLETE: 'Thanks!  Let me reward you for your help.',
 ...
 1063: (TT_TIER + 3,
        ...
        NA,
        1067,
        {QUEST: 'Hi, thanks for coming in.\x07A Cog stole a very important package from right under my nose.\x07Please see if you can get it back.  I think he was a level three...\x07So, defeat level 3 Cogs until you find my package.',
         LEAVING: '',
 ...
 1068: (TT_TIER + 3,
        ...
        NA,
        (1069, 1070, 1071),
        {QUEST: "I wasn't expecting a package.  Maybe it's for Dr. I.M. Euphoric?\x07My assistant was going over there today anyway, so I'll have him check for you.\x07In the meantime, would you mind getting rid of some of the Cogs on my street?\x07Defeat 10 Cogs in Toontown Central.",
         LEAVING: '',
 ...
 1069: (TT_TIER + 3,
        ...
        NA,
        1072,
        {QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Cashbot stole it from my assistant on the way back.\x07I'm sorry, but you'll have to find that Cashbot and get it back.",
         LEAVING: '',
         INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'}),
 1070: (TT_TIER + 3,
        Cont,
 ...
 1071: (TT_TIER + 3,
        ...
        NA,
        1072,
        {QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Lawbot stole it from my assistant on the way back.\x07I'm sorry, but you'll have to find that Lawbot and get it back.",
         LEAVING: '',
         INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'}),
 1072: (TT_TIER + 3,
        Cont,
 ...
 1220: (TT_TIER + 2,
        ...
        NA,
        1221,
        {QUEST: ('I heard _toNpcName_ is looking for you._where_', 'Stop by and see _toNpcName_ when you get a chance._where_', 'Pay a visit to _toNpcName_ next time you are over that way._where_', 'If you get a chance, stop in and say hi to _toNpcName_._where_', '_toNpcName_ will give you your next ToonTask._where_'),
         LEAVING: ('Bye!', 'Goodbye!', 'So long, _avName_.', 'See ya, _avName_!', 'Good luck!', 'Have fun in Toontown!', 'See you later!')}),
 1221: (TT_TIER + 2,
        Start,
        (DeliverItemQuest, 21),
        ...
        NA,
        (1222, 1223),
        {QUEST: "Thanks for stopping in.\x07I've got a really special case for you.\x07Awhile back we had a new Toon named Daphne enter Toontown.\x07She was a bright, young, smart crocodile.  Always shined wherever she went with her gadgets and such.\x07She then made a special device that allowed her to...\x07Well...\x07I think it's best you see for yourself.\x07And while you're at it, deliver this PB&J sandwich.  She's probably hungry for a little something.",
         INCOMPLETE: "What are you doing?  Don't leave Daphne alone!",
         LEAVING: 'You can find her in her hideout across Barely Platable Pasta.'}),
 1222: (TT_TIER + 2,
        Cont,
        (CogQuest,
         Anywhere,
        ...
        NA,
        1224,
        {QUEST: "N-Nancy?\x07H-huh?  Who are you?\x07_avName_, huh?  And Nurse Nancy sent you?\x07I-I don't look scary, do I?\x07Anyways, thanks for coming.  A-and thanks for the food.\x07I could really use your help if you're up for it.\x07There are some new Cogs roaming the streets of Toontown that I wanted to look at.  Cogs no Toon has ever seen before.\x07The Copy Jockey and the Patronizer.\x07They only seem to have just joined the Cogs in their attempt to take over Toontown.\x07I'd do it myself, but I'm afraid of what the Toons will think of me...\x07And besides, I couldn't hurt a Cog to keep me from going sad.\x07Could you find and take down one Patronizer for me, please?\x07Please also tell me about them."}),
 1223: (TT_TIER + 2,
        Cont,
        (CogQuest,
         Anywhere,
        ...
        NA,
        1224,
        {QUEST: "N-Nancy?\x07H-huh?  Who are you?\x07_avName_, huh?  And Nurse Nancy sent you?\x07I-I don't look scary, do I?\x07Anyways, thanks for coming.  A-and thanks for the food.\x07I could really use your help if you're up for it.\x07There are some new Cogs roaming the streets of Toontown that I wanted to look at.  Cogs no Toon has ever seen before.\x07The Copy Jockey and the Patronizer.\x07They only seem to have just joined the Cogs in their attempt to take over Toontown.\x07I'd do it myself, but I'm afraid of what the Toons will think of me...\x07And besides, I couldn't hurt a Cog to keep me from going sad.\x07Could you find and take down one Copy Jockey for me, please?\x07Please also tell me about them."}),
 1224: (TT_TIER + 2,
        Cont,
        (VisitQuest,),
        2317,
        ...
        {GREETING: 'Hello again!',
         QUEST: "That does sound interesting.\x07You know, I still want to communicate with others outside of this shop.\x07Besides Nurse Nancy I've never really had anyone to talk to.\x07I'm... just afraid of what the Toons would think of me.\x07I'm not as small as I used to be.\x07You know, I used to be around your height.\x07Then I made a special device which caused me to grow a little too much.\x07Now I'm a giant crocodile.  I think everyone, besides Nurse Nancy, would be scared of my newfound height.\x07I can't go out like this, so I thought I'd communicate with fellow Toons through the use of robots.\x07All I need is some circuitry.\x07There's a shopkeeper, Professor Control, who can provide that.\x07Please see if he's got any circuits to spare._where_",
         INCOMPLETE: 'Have you got the circuitry yet?',
         LEAVING: ''}),
 1225: (TT_TIER + 2,
        Cont,
        (RecoverItemQuest,
        ...
        1227,
        {GREETING: '',
         QUEST: "If it's circuitry ya want, I ain't got any.\x07Ye got de new Cogs ta' blame.",
         INCOMPLETE: "Here fa' circuitry?",
         LEAVING: "I cannot help ya 'til I git back five circuits from dem Patroniza's."}),
 1226: (TT_TIER + 2,
        Cont,
        (RecoverItemQuest,
         Anywhere,
        ...
        {GREETING: '',
         QUEST: "If it's circuitry ya want, I ain't got any.\x07Ye got de new Cogs ta' blame.",
         INCOMPLETE: "Here fa' circuitry?",
         LEAVING: "I cannot help ya 'til I git back five circuits from dem Copy Jocks."}),
 1227: (TT_TIER + 2,
        Start,
        (VisitQuest,),
        2310,
        ...
        NA,
        {GREETING: '',
         QUEST: "Thanks!\x07Say, are dese fa' Daphne?  Is she still 'roun'?\x07She used to share everythin' wit' us Toons.  All 'er projects, where she was goin'...\x07But when she talked about a project involving a transformation o' 'er size, we 'adn't 'eard from 'er.\x07Oh?  She's scared of what da Toons'll think o' 'er and 'er colossal size?\x07Buddy, hush.\x07She ain't got a thin' ta' worry 'bout.\x07'Cause even if she's towerin' o'er us by far too much...\x07At 'eart she's still our li'l Daph-\x04o-\x04dill!\x07Still da pure-\x04hearted crocodile we knew when she came...\x07Still da bright an' bubbly Toon we know...\x07An' still de most wholesome Toon in Toontown!\x07I will not be givin' dese circuits ta' 'er if what she's workin' on is a way ta' communicate wit' us.\x07She's completely capable o' talkin' to us 'erself.\x07Tell 'er she'll be completely fine an' dandy even if she looks much larger dan all o' us.",
         INCOMPLETE: "Dese circuits ain't fo' ye or fo' Daph-\x04o-\x04dill.\x07She's completely capable o' talkin' to us 'erself.\x07Tell 'er she'll be completely fine an' dandy even if she looks much larger dan all o' us.",
         COMPLETE: "Have you got the circuitry yet?\x07The Professor says that the Toons wouldn't mind my size?  But I'm...\x07Well...\x07Well, if Nurse Nancy and you feel comfortable around me and the Professor doesn't see anything wrong...\x07I guess I could appoint a day where I can face the town again.\x07Thanks for helping me, by the way!\x07I'd give you a big hug, but I don't want to break your bones.\x07Here!  I can repay you another way!",
         LEAVING: 'Good-\x04bye!'}),
 401: (DD_TIER,
       Start,
 ...
 3264: (DG_TIER,
        ...
        NA,
        {GREETING: '',
         QUEST: 'Hey buddy, nice work on that Factory!\x07Looks like you found part of a Cog suit.\x07It must be left over from their Cog manufacturing process.\x07That may come in handy. Keep collecting these when you have spare time.\x07Maybe when you collect an entire Cog suit it could be useful for something...\x07You should speak with Professor Control about this._where_',
         COMPLETE: "Welcome ta' de Professa's Circuit Circus, 'ome o' de finest circuitry o' Toontown!  Me name's Professa' Control; 'ow may I 'elp ya?\x07Ye ain't 'ere fa' circuitry?  Den what'cha 'ere fo'?\x07Oh!  Coach Zucchini sent'cha?  Cog suit part?\x07Ah, ja... Interestin'...\x07Keep ya' guard up.  I'm sort o' interested in what ya' can do wit' a full suit.\x07Oh!  Ye deserve a reward fa' ya' work!"}),
 3500: (DG_TIER,
        Start,
        (CogQuest,
         ToontownGlobals.DaisyGardens,
 ...
 4001: (MM_TIER,
        ...
        {GREETING: '',
         ...
         LEAVING: TTLocalizer.QuestsDefaultLeaving}),
 4002: (MM_TIER,
        Start,
 ...
 4202: (MM_TIER + 1,
        ...
        NA,
        4203,
        {QUEST: 'Yes, I talked to Tom this morning.\x07I have the inventory right here.\x07Bring it right back to him, okay?_where_'}),
 4203: (MM_TIER + 1,
        Cont,
        (VisitQuest,),
        Same,
 ...
 4206: (MM_TIER + 1,
        ...
        NA,
        4207,
        {QUEST: "Hmmm, very interesting.\x07Now we are getting somewhere.\x07Okay, the last inventory is Fifi's._where_"}),
 4207: (MM_TIER + 1,
        Cont,
        (VisitQuest,),
        Same,
 ...
 7242: (DL_TIER + 1,
        ...
        {GREETING: '',
         ...
         INCOMPLETE_PROGRESS: "Not a strip of slimy kelp in the shop.\x07I can't make the cream without it."}),
 7243: (DL_TIER + 1,
        Cont,
        (RecoverItemQuest,
         ToontownGlobals.CashbotHQ,
 ...
 7301: (DL_TIER + 1,
        ...
        100, # reward
        NA,
        {GREETING: 'Hiya, _avName_!',
         LEAVING: 'See you later!',
         QUEST: "Thanks for stopping in!\x07Those blasted Cogs stole my precious film rolls!\x07I cannot run a movie house without film!\x07Please!  Rush out and collect the film rolls that those dreaded Cogs nabbed!",
         INCOMPLETE_PROGRESS: 'Do you have the film rolls?\x07I need them, urgently, please!',
         COMPLETE: "You got the film?\x07Hooray!  I'm back in business!\x07Take this as a well-\x04deserved reward, _avName_!"}),
 7500: (DL_TIER + 1,
        Start,
        (CogQuest,
         ToontownGlobals.DonaldsDreamland,
 ...
 11001: (LAWBOT_HQ_TIER,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Yes, yes. I have Lawbot disguise parts.\x07But they are of no interest to me.\x07The focus of my research is fluctuations in the ambient temperature of Toontown.\x07I will gladly trade you disguise parts for Cog temperature sensors.\x07You can start on Silly Street.',
          INCOMPLETE_PROGRESS: 'Have you tried looking on Silly Street?',
 ...
 11002: (LAWBOT_HQ_TIER + 1,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'For more Lawbot disguise parts you should visit _toNpcName_ again.\x07I hear he needs more research assistance._where_'}),
 11003: (LAWBOT_HQ_TIER + 1,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'More Lawbot disguise parts?\x07Well, if you insist...\x07but I will require another Cog temperature sensor.\x07This time look on Loopy Lane.',
          INCOMPLETE_PROGRESS: 'You are looking on Loopy Lane, right?',
 ...
 11005: (LAWBOT_HQ_TIER + 2,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: "You're proving yourself quite useful!\x07Can you take a look on Punchline Place?",
          INCOMPLETE_PROGRESS: "Are you sure you're looking on Punchline Place?",
 ...
 11006: (LAWBOT_HQ_TIER + 3,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'You-\x04know-\x04who needs more temperature readings.\x07Stop by if you would like another disguise part._where_'}),
 11007: (LAWBOT_HQ_TIER + 3,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Back again?\x07You are very dedicated...\x07The next stop is Barnacle Boulevard.',
          INCOMPLETE_PROGRESS: 'Have you tried looking on Barnacle Boulevard?',
 ...
 11009: (LAWBOT_HQ_TIER + 4,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Fancy seeing you here!\x07Now I need readings on Seaweed Street.',
          INCOMPLETE_PROGRESS: 'You are looking on Seaweed Street, right?',
 ...
 11011: (LAWBOT_HQ_TIER + 5,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Good to see you again, _avName_!\x07Can you get a reading on Lighthouse Lane, please?',
          INCOMPLETE_PROGRESS: 'Have you tried looking on Lighthouse Lane?',
 ...
 11013: (LAWBOT_HQ_TIER + 6,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: '_avName_, my dear friend!\x07Can you go to Elm Street and find another temperature sensor?',
          INCOMPLETE_PROGRESS: "Are you sure you're looking on Elm Street?",
 ...
 11015: (LAWBOT_HQ_TIER + 7,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: "Welcome back!\x07I've been waiting for you.\x07The next reading I need is on Maple Street.",
          INCOMPLETE_PROGRESS: 'You are looking on Maple Street, right?',
 ...
 11017: (LAWBOT_HQ_TIER + 8,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Hello, Junior Research Scientist!\x07We still need readings from Oak Street.',
          INCOMPLETE_PROGRESS: 'Have you tried looking on Oak Street?',
 ...
 11019: (LAWBOT_HQ_TIER + 9,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Well, then.\x07Are you ready for another recovery?\x07This time try Alto Avenue.',
          INCOMPLETE_PROGRESS: "Are you sure you're looking on Alto Avenue?",
 ...
 11021: (LAWBOT_HQ_TIER + 10,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'You could probably guess by now...\x07but I need readings from Baritone Boulevard.',
          INCOMPLETE_PROGRESS: 'You are looking on Baritone Boulevard, right?',
 ...
 11023: (LAWBOT_HQ_TIER + 11,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'What do you think about Tenor Terrace? Could you get a sensor from there too?',
          INCOMPLETE_PROGRESS: 'Have you tried looking on Tenor Terrace?',
 ...
 11024: (LAWBOT_HQ_TIER + 12,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Go visit _toNpcName_ if you still need disguise parts._where_'}),
 11025: (LAWBOT_HQ_TIER + 12,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'I believe we still need a reading from Lullaby Lane.',
          INCOMPLETE_PROGRESS: "Are you sure you're looking on Lullaby Lane?",
 ...
 11027: (LAWBOT_HQ_TIER + 13,
         ...
         {GREETING: '',
          LEAVING: '',
          QUEST: 'Back so soon?\x07The final reading is on Pajama Place.',
          INCOMPLETE_PROGRESS: 'You are looking on Pajama Place, right?',
          COMPLETE: "You're all done!\x07Now you are ready to infiltrate the District Attorney's Office and collect Jury Notices for your new disguise.\x07Good luck and thanks for all your help!"}),
 ...
 12032: (BOSSBOT_HQ_TIER + 16,
         ...
         {GREETING: '',
          ...
          COMPLETE: 'A new type of Cog!\x07Good work!  Here is your final disguise part.'})}
...
def chooseQuestDialogReject():
    # TODO: Allow for certain NPCs to say custom things, not just the lines listed in DefaultReject.
...
def getNpcLocationDialog(fromNpcId, toNpcId):
    ...
    paragraph = TTLocalizer.QuestsLocationParagraph % {'building': "%s's building is called" % toNpcName,
