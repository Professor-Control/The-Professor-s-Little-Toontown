...
class BossCog(Avatar.Avatar):
    ...
    def generateBossCog(self):
        ...
        self.grunt = loader.loadSfx('phase_9/audio/dial/Boss_COG_VO_grunt.ogg')
        self.murmur = loader.loadSfx('phase_9/audio/dial/Boss_COG_VO_murmur.ogg')
        self.statement = loader.loadSfx('phase_9/audio/dial/Boss_COG_VO_statement.ogg')
        self.question = loader.loadSfx('phase_9/audio/dial/Boss_COG_VO_question.ogg')
