...
class DistributedBossbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self.setName('Chief Executive Officer')
        ...
        self.warningSfx = loader.loadSfx('phase_5/audio/dial/Skel_COG_VO_grunt.ogg')
    ...
    def loadEnvironment(self):
        ...
        self.battleOneMusic = base.loader.loadMusic('phase_14/audio/bgm/encntr_derrick.ogg')
        ...
        self.battleThreeMusic = base.loader.loadMusic('phase_14/audio/bgm/encntr_suit_winning_BTL3_WSI.ogg')
    ...
    def __makeResistanceToon(self):
        ...
        self.resistanceToon.suitType = 'hho'
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        track = Sequence(Func(camera.reparentTo, render), Func(camera.setPosHpr, *elevCamPosHpr), Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTWelcome, CFSpeech), LerpPosHprInterval(camera, 3, closeUpRTCamPos, closeUpRTCamHpr), Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTRemoveSuit, CFSpeech), Wait(3), Func(self.clearChat), self.loseCogSuits(self.toonsA + self.toonsB, render, (loseSuitCamPos[0],
         loseSuitCamPos[1],
         loseSuitCamPos[2],
         loseSuitCamHpr[0],
         loseSuitCamHpr[1],
         loseSuitCamHpr[2])), self.toonNormalEyes(self.involvedToons), Wait(2), Func(camera.setPosHpr, closeUpRTCamPos, closeUpRTCamHpr), Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTFightWaiter, CFSpeech), Wait(1), LerpHprInterval(camera, 2, Point3(-15, 5, 0)), Sequence(Func(rToon.suit.loop, 'walk'), rToon.hprInterval(1, VBase3(270, 0, 0)), rToon.posInterval(2.5, rToonEndPos), Func(rToon.suit.loop, 'neutral')), Wait(3), Func(rToon.clearChat), Func(self.__hideResistanceToon))
        return track
    ...
    def makePrepareBattleTwoMovie(self, delayDeletes):
        ...
        track = Sequence(
            ...
            Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTWearWaiter, CFSpeech),
            Wait(3.0),
            ...
            Func(self.setChatAbsolute, TTLocalizer.BossbotBossPreTwo1, CFSpeech),
            Wait(3.0),
            Func(self.setChatAbsolute, TTLocalizer.BossbotBossPreTwo2, CFSpeech),
            Wait(3.0),
            Parallel(
            ...
            Func(self.clearChat),
            Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTServeFood1, CFSpeech),
            Wait(3.0),
            Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTServeFood2, CFSpeech),
            Wait(1.0),
    ...
    def makePrepareBattleThreeMovie(self):
        ...
        track = Sequence(
            ...
            Func(self.setChatAbsolute, TTLocalizer.BossbotPhase3Speech1, CFSpeech),
            Wait(3.0),
            Func(self.setChatAbsolute, TTLocalizer.BossbotPhase3Speech2, CFSpeech),
            Wait(3.0),
            ...
            Func(camera.setPos, Point3(0, -45, 5)),
            Func(camera.setHpr, Point3(0, 14, 0)),
            Func(self.setChatAbsolute, TTLocalizer.BossbotPhase3Speech3, CFSpeech),
            Wait(3.0),
            Func(self.clearChat))
        return track
    ...
    def makePrepareBattleFourMovie(self):
        ...
        track = Sequence(
            ...
            Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTPhase4Speech1, CFSpeech),
            Wait(4.0),
            Func(rToon.setChatAbsolute, TTLocalizer.BossbotRTPhase4Speech2, CFSpeech),
            Wait(4.0),
            Func(self.__hideResistanceToon),
            Func(camera.reparentTo, self),
            Func(camera.setPos, Point3(0, -45, 5)),
            Func(camera.setHpr, Point3(0, 14, 0)),
            Func(self.setChatAbsolute, TTLocalizer.BossbotPhase4Speech1, CFSpeech),
            Func(self.banquetDoor.setH, 0),
            Wait(3.0),
            Func(self.setChatAbsolute, TTLocalizer.BossbotPhase4Speech2, CFSpeech),
    ...
    def makeVictoryMovie(self):
        ...
        bossTrack = Sequence(
            ...
            Func(self.setChatAbsolute, TTLocalizer.BossbotRewardSpeech1, CFSpeech),
            Wait(3.0),
            Func(self.setChatAbsolute, TTLocalizer.BossbotRewardSpeech2, CFSpeech),
            Wait(2.0),
            Func(self.clearChat),
            Parallel(
                Sequence(
