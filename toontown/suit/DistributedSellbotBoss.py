...
class DistributedSellbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self.setName('Chief Marketing Officer')
        nameInfo = '%(name)s\n%(dept)s' % {'name': self._name,
        ...
        self.piesRestockSfx = loader.loadSfx('phase_5/audio/sfx/SA_watercooler_spray_only.ogg')
    ...
    def cagedToonMovieFunction(self, instruct, cageIndex):
        ...
        if instruct == 1:
            ...
            self.cagedToon.setChatAbsolute(["Great job!  You're wearing him down!", "Keep after him!  He's on the run!", 'You guys are doing great!', "Fantastic!  You've almost got him now!"][cageIndex], CFSpeech)
        elif instruct == 3:
    ...
    def loadEnvironment(self):
        ...
        self.battleOneMusic = base.loader.loadMusic('phase_14/audio/bgm/encntr_suit_winning_BTL3_WSI.ogg')
        self.battleTwoMusic = base.loader.loadMusic('phase_14/audio/bgm/encntr_vp_suits.ogg')
        self.battleThreeMusic = base.loader.loadMusic('phase_14/audio/bgm/encntr_vp_pie.ogg')
