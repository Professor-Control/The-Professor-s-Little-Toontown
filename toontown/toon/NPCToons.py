...
def createNPC(air, npcId, desc, zoneId, posIndex = 0, questCallback = None):
    ...
    import DistributedNPCDaphneAI
    import DistributedNPCBigBenAI
    import DistributedNPCSaltySammyAI
    ...
    elif type == NPC_DAPHNE:
        npc = DistributedNPCDaphneAI.DistributedNPCDaphneAI(air, npcId)
    elif type == NPC_BIGBEN:
        npc = DistributedNPCBigBenAI.DistributedNPCBigBenAI(air, npcId)
    elif type == NPC_SALTYSAMMY:
        npc = DistributedNPCSaltySammyAI.DistributedNPCSaltySammyAI(air, npcId)
    else:
...
#         lnames[20000],    | This is the name of the NPC Toon.
...
if config.GetBool('want-new-toonhall', 1):
    ...
    NPCToonDict[2001] = (2513,
     ...
     NPC_REGULAR)
del lnames
BlockerPositions = {'Flippy': (Point3(207.4, 18.81, -0.475), 90.0)}
zone2NpcDict = {}
...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK, # Gag track
        5, # Gag level
        ToontownGlobals.MaxHpLimit, # Damage
        5), # Rating
 3114: (ToontownBattleGlobals.HEAL_TRACK,
        5,
        132,
        5),
 2018: (ToontownBattleGlobals.HEAL_TRACK,
        ...
        120,
        5),
 9116: (ToontownBattleGlobals.HEAL_TRACK,
        3,
        95,
        4),
 ...
 2121: (ToontownBattleGlobals.HEAL_TRACK,
        ...
        45,
        3),
 2006: (ToontownBattleGlobals.TRAP_TRACK,
        6,
        195,
        5),
 ...
 1001: (ToontownBattleGlobals.TRAP_TRACK,
        ...
        50,
        3),
 1002: (ToontownBattleGlobals.TRAP_TRACK,
        3,
        50,
        3),
 3112: (ToontownBattleGlobals.LURE_TRACK,
        ...
        0,
        5),
 2310: (ToontownBattleGlobals.LURE_TRACK,
        5,
        0,
        4),
 1323: (ToontownBattleGlobals.LURE_TRACK,
        ...
        0,
        4),
 9204: (ToontownBattleGlobals.LURE_TRACK,
        5,
        0,
        4),
 2308: (ToontownBattleGlobals.LURE_TRACK,
        ...
        0,
        3),
 9219: (ToontownBattleGlobals.LURE_TRACK,
        3,
        0,
        3),
 ...
 4115: (ToontownBattleGlobals.SOUND_TRACK,
        ...
        40,
        3),
 2002: (ToontownBattleGlobals.DROP_TRACK,
        4,
        198,
        5),
 1116: (ToontownBattleGlobals.DROP_TRACK,
        ...
        170,
        5),
 9137: (ToontownBattleGlobals.DROP_TRACK,
        5,
        170,
        5),
 1107: (ToontownBattleGlobals.DROP_TRACK,
        3,
        145,
        5),
 2311: (ToontownBattleGlobals.DROP_TRACK,
        ...
        100,
        4),
 2127: (ToontownBattleGlobals.DROP_TRACK,
        5,
        75,
        3),
 4140: (ToontownBattleGlobals.DROP_TRACK,
        ...
        60,
        3),
 2004: (ToontownBattleGlobals.NPC_COGS_MISS,
        0,
        0,
        4),
 ...
 4327: (ToontownBattleGlobals.NPC_COGS_MISS,
        ...
        0,
        4),
 5213: (ToontownBattleGlobals.NPC_COGS_MISS,
        0,
        0,
        4),
 ...
 5124: (ToontownBattleGlobals.NPC_TOONS_HIT,
        ...
        0,
        4),
 1325: (ToontownBattleGlobals.NPC_TOONS_HIT,
        0,
        0,
        4),
 2003: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        5),
 5120: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        -1,
        0,
        5),
 2126: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        3),
 4006: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
 ...
 1315: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        3),
 5204: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ToontownBattleGlobals.LURE_TRACK,
        0,
        3),
 2207: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
 ...
 4125: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        3),
 4108: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
 ...
 5207: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        3),
 5223: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ToontownBattleGlobals.SQUIRT_TRACK,
        0,
        3),
