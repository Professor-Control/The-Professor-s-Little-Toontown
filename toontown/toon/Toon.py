...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def putOnSuit(self, suitType, setDisplayName = True, rental = False):
        ...
        if setDisplayName:
            ...
            self.nametag.setDisplayName('%(name)s\n%(dept)s\nLevel %(level)s' % {'name': name,
             'dept': suitName,
    ...
    def getPieSplatInterval(self, x, y, z, pieCode):
        ...
        if pieName == 'lawbook':
            ...
            vol = 0.25
        elif pieName == 'waterBalloon':
            sound = loader.loadSfx('phase_4/audio/sfx/Seltzer_squirt_2dgame_hit.ogg')
        else:
