...
NPCTracks = ['restock', 'toons hit', 'cogs miss']
...
NUM_GAG_TRACKS = 7
PropTypeToTrackBonus = {AnimPropTypes.Hydrant: 5,
 AnimPropTypes.Mailbox: 4,
 AnimPropTypes.Trashcan: 0}
Levels = [[0,
  20,
  200,
  800,
...
AvPropStrings = (('Feather',
 ...
 ('Flower Pot',
  ...
  'Grand Piano',
  'Oceanliner'))
AvPropStringsSingular = (('a Feather',
  'a Megaphone',
  'a Lipstick',
  'a Bamboo Cane',
  'a Pixie Dust',
