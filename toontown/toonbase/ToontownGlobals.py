...
CogSuitHPLevels = (15 - 1,
 ...
 40 - 1,
 50 - 1)
setInterfaceFont('phase_3/models/fonts/ImpressBT.ttf')
setSignFont('phase_3/models/fonts/MickeyFont')
...
def getBuildingNametagFont():
    ...
    if BuildingNametagFont == None:
        BuildingNametagFont = loader.loadFont('phase_3/models/fonts/MickeyFont')
...
StreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 10000: ('to', 'in the', 'Bossbot HQ Country Club'),
 ...
 12000: ('to', 'in the', 'Cashbot Train Yard'),
...
dnaMap = {Tutorial: 'toontown_central',
 ...
 GolfZone: 'golf_zone'}
hoodNameMap = {DonaldsDock: ('to', 'in', "Donald's Dock"),
